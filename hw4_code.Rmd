...
ggplot(data = warming, aes(x = year, y = warming_norm_damage)) +
  geom_line()+ labs(x = "Year", y = "Damages from Climate Change ($)", title = "Annual Damages to Temperature Under Normal Conditions")
```
...
## Graph 2: Damages Over time with the pulse
 ggplot(data = warming, aes(x = year, y = warming_pulse_damage)) +
  geom_line()+ labs(x = "Year", y = "Damages from Climate Change ($)", title = "Annual Damages to Temperature With CO2 Pulse")
```
...
## Graph 3: Difference in Damages over time from the pulse 
 ggplot(data = warming, aes(x = year, y = warming_damage_diff)) +
  geom_line()+ labs(x = "Year", y = "Difference in Damages from Climate Change ($)", title = "Annual Difference in Damages to Temperature With CO2 Pulse")
```
...
caption <- "Figure 6. the gold dot represents the Ramsey Rate discount rate and Social Cost of Carbon calculation"
ggplot() +
...
ggplot() +
  ...
  labs(x = "Implenetation Cost ($)",
       ...
       caption = "Figure 7. Policy A (purple) indicates there is no implementation cost. Policy B (orange) shows there is an implementation cost of X") +
  theme_minimal()
