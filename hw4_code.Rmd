...
warming <- warming %>% 
  mutate(warming_damage_diff_per_CO2, present_value_ramsey = warming_damage_diff_per_CO2 / (1 + .021)^(...1))
...
warming <- warming %>% 
  mutate(warming_norm_damage, policy_A_opt1 = (warming_norm_damage / (1 + .02)^(...1)))
...
warming <- warming %>% 
  mutate(warming_1.5_damage, policy_A_opt2 = ((warming_1.5_damage) / (1 + .02)^(...1)))
...
warming <- warming %>% 
  mutate(warming_norm_damage, pv_option_b = warming_norm_damage / (1 + .02)^(...1))

warming <- warming %>%
  mutate(warming_norm_damage, steady = warming_norm_damage[30] / (1 + .02)^(...1))
